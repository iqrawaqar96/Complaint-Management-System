...
import com.devolper.complaintfyp.adapters.Delete_User_Adapter;
...
public class delAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userAuth.setContext(delAccount.this);
        setTitle("Delete Account");
        if(userAuth.userData() == null){
            Intent openLogin = new Intent(delAccount.this,chooseSigninActivity.class);
            startActivity(openLogin);
        }
        else{
            if(myDb.getProfileData().get(6).toString().equalsIgnoreCase("students")){
                Intent openLogin = new Intent(delAccount.this,homeActivity.class);
                startActivity(openLogin);
            }
            else{
    ...
    private void get_data() {
        ...
        db.child("users").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Delete_User_Adapter adapter=new Delete_User_Adapter(getApplicationContext(),users);
    ...
    public void onBackPressed() {
        Intent openLogin = new Intent(delAccount.this,adminHome.class);
        startActivity(openLogin);
